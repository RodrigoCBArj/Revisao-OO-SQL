...
('Pizza de Calabresa', 50.0, 'https://github.com/rodrigocbarj/1.png', 'Pizza calabresa com queijo, molho e massa especial'),
('Pizza Quatro Queijos', 40.0, 'https://github.com/rodrigocbarj/2.png', 'Pizza quatro queijos muito boa'),
('Pizza de Escarola', 60.0, 'https://github.com/rodrigocbarj/3.png', 'Pizza escarola muito boa');
...
## Query para consultar os pedidos com seus respectivos produtos
```sql
